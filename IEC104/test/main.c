...
{  
    ...
    servaddr.sin_port = htons(((PClientInfo_T)arg)->server_port);
    
    servaddr.sin_addr.s_addr = ((PClientInfo_T)arg)->server_ip;
/*
...
int main(int argc, char *argv[]){
    ...
    if(mode == SOCKET_MODE_SERVER){
        ...
        for(i=0; i<NumSta; i++){
            ...
            clientinfo.server_ip = Addr;
            clientinfo.server_port = Port;
